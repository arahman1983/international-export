...
export default function CategoryForm({type, item, handleClose, editItem, addItem}){
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      type === 'add'
      ? addItem({ title: values.title, title_ar: values.title_ar, createdAt: new Date().toLocaleString(), updatedAt: new Date().toLocaleString() , isDeleted: false})
      : editItem({...item, title: values.title, title_ar: values.title_ar })
    },
  })
  return(
